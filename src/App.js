      ...
      <div className="App">
          <Grid >
            <Row className="show-grid">
              <Col md={12}>
                <Geo unit={this.props.country.unit} colorBy={this.props.country.colorBy} scaleColorBy={this.props.country.scaleColorBy} geoChart_data={this.props.country.geoChart_data}/>
              </Col>
            </Row>
            <Row className="show-grid">
              <Col xs={12} md={12}>
